...
<div class="utk-hours">
    ...
    <div class="utk-hours--listing">
        <ul class="utk-hours--listing--col" aria-label="hodges library and locations inside">
            <li class="utk-hours--listing--item "><a href="https://lib.utk.edu" class="library-open">
                    ...
                    <div class="utk-hours--listing--item--meta"><span
                                ...
                                class="utk-hours--listing--item--hours">@php LibCal::the_hours_by_lid(52) @endphp</span></div>
                </a>
                ...
                <a class="utk-hours--listing--item--more"><span class="icon-plus">3</span> Show More at
                    Hodges</a></li>
        </ul>

...
class Formal extends Controller
{
    ...
    public static function getFormalHeader($post_id, $heading = false)
    {
        ...
        if (get_post_type() === 'space' && !is_archive()) :
            $location_link = '<div class="utk-space--header--meta--item"><svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="map-marker-alt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512"><title>space location</title><path d="M172.268 501.67C26.97 291.031 0 269.413 0 192 0 85.961 85.961 0 192 0s192 85.961 192 192c0 77.413-26.97 99.031-172.268 309.67-9.535 13.774-29.93 13.773-39.464 0zM192 272c44.183 0 80-35.817 80-80s-35.817-80-80-80-80 35.817-80 80 35.817 80 80 80z" class=""></path></svg>' . Space::getSpaceLocations($post_id, true) . '</div>';
            $location_type = '<div class="utk-space--header--meta--item"><svg id="utk_svg_space_space" data-name="utk_svg_space_space" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 80.116 73.463"><title>space type</title><polygon points="0 51.686 0 22.334 37.324 44.735 37.324 73.463 0 51.686"/><polygon points="42.793 44.735 80.116 22.332 80.116 51.686 42.793 73.463 42.793 44.735"/><polygon points="42.727 28.725 42.727 0 76.714 19.828 52.308 34.477 42.727 28.725"/><polygon points="3.404 19.828 37.387 0 37.387 28.725 27.809 34.477 3.404 19.828"/></svg>' . Space::getSpaceType($post_id) . '</div>';
            $content = '<div class="utk-space--header--meta">' . $location_link . $location_type . '</div>';
        else:
